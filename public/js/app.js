...
/* harmony import */ var __WEBPACK_IMPORTED_MODULE_0__class_Blur_js__ = __webpack_require__(21);
/* harmony import */ var __WEBPACK_IMPORTED_MODULE_1__class_Carousel_js__ = __webpack_require__(22);
/**
...
$(function () {
    ...
    $('#form-contact').on('submit', function (e) {
        ...
        var timerRunning = Date.now() >= start + end;
        ...
        if (timerRunning) {
            ...
            var timeLeft = end / 1000 - Math.floor((Date.now() - start) / 1000);
            var counter = 1;
            ...
            var submitTimerMessageId = setInterval(function () {
    ...
    __WEBPACK_IMPORTED_MODULE_0__class_Blur_js__["a" /* default */].bind('.card-skill');
    __WEBPACK_IMPORTED_MODULE_0__class_Blur_js__["a" /* default */].bind('.card-hobbies-container');
    __WEBPACK_IMPORTED_MODULE_1__class_Carousel_js__["a" /* default */].bind('.card-experiences');
});
    ...
    _createClass(Carousel, [{
        ...
        value: function createBubbles() {
            ...
            for (var i = 0; i < this.pictures.length; i++) {
                var bubble = $('<span class="carousel-bubble"></span>');
        ...
        key: 'bubbleClick',
        value: function bubbleClick(index) {
        ...
        value: function updateBubbles() {
            ...
            var bubbles = this.container.next().children('.carousel-bubble').each(function () {
                $(this).removeClass('active');
            });
        ...
        value: function checkIndex(index) {
            var picturesLength = this.pictures.length - 1;
