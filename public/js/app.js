...
Vue.component('carousel', __webpack_require__(61));
Vue.component('skill', __webpack_require__(72));
Vue.component('hobby', __webpack_require__(77));
Vue.component('contact', __webpack_require__(82));
Vue.component('flash', __webpack_require__(87));
...
$(function () {
    ...
    function getNavbarHeight() {
        ...
        var totalHeight = navbar.height() + parseInt(navbar.css('padding-top')) + parseInt(navbar.css('padding-bottom')) + parseInt(navbar.css('border-bottom-width'));
    ...
    function setCurrentSession() {
        ...
        sections.each(function (section) {
            ...
            var sectionY = $(this).offset().top;
            var offsetTop = sectionY - getNavbarHeight() - 200;
    ...
    $('.email-footer-badge').on('click', function () {
        ...
        var $temp = $('<input id="tempo" type="text" value=' + $('#test123').text() + '>');
...
/* WEBPACK VAR INJECTION */}.call(exports, __webpack_require__(17), __webpack_require__(59).setImmediate))
...
/* harmony default export */ __webpack_exports__["default"] = ({
    ...
    components: { Slide: __WEBPACK_IMPORTED_MODULE_0__Slide_vue___default.a },
...
if(content.locals) module.exports = content.locals;
// add the styles to the DOM
var update = __webpack_require__(3)("d7319440", content, false, {});
// Hot Module Replacement
if(false) {
 // When the styles change, update the <style> tags
 if(!content.locals) {
...
/* harmony default export */ __webpack_exports__["default"] = ({
    ...
    props: { slide: { type: Object } },
    data: function data() {
        return {
            id: this.slide.id,
            path: this.slide.path,
            alt: this.slide.alt
        };
    },
    ...
    computed: {
        backgroundImage: function backgroundImage() {
            return { 'background-image': 'url(/storage/' + this.path + ' )' };
        }
    }
...
var render = function() {
  ...
  return _c("div", {
    staticClass: "experience-img slide",
...
Component.options.__file = "resources/assets/js/components/Skill.vue"
...
if (false) {(function () {
  ...
  module.hot.accept()
  if (!module.hot.data) {
    hotAPI.createRecord("data-v-83d87bac", Component.options)
  } else {
    hotAPI.reload("data-v-83d87bac", Component.options)
  }
  module.hot.dispose(function (data) {
    disposed = true
  })
...
if(content.locals) module.exports = content.locals;
// add the styles to the DOM
var update = __webpack_require__(3)("aeb51a9a", content, false, {});
// Hot Module Replacement
if(false) {
 // When the styles change, update the <style> tags
 if(!content.locals) {
   module.hot.accept("!!../../../../node_modules/css-loader/index.js!../../../../node_modules/vue-loader/lib/style-compiler/index.js?{\"vue\":true,\"id\":\"data-v-83d87bac\",\"scoped\":false,\"hasInlineConfig\":true}!../../../../node_modules/vue-loader/lib/selector.js?type=styles&index=0!./Skill.vue", function() {
     var newContent = require("!!../../../../node_modules/css-loader/index.js!../../../../node_modules/vue-loader/lib/style-compiler/index.js?{\"vue\":true,\"id\":\"data-v-83d87bac\",\"scoped\":false,\"hasInlineConfig\":true}!../../../../node_modules/vue-loader/lib/selector.js?type=styles&index=0!./Skill.vue");
     if(typeof newContent === 'string') newContent = [[module.id, newContent, '']];
     update(newContent);
   });
 }
...
/* harmony default export */ __webpack_exports__["default"] = ({
    ...
    computed: {
        ...
        image: function image() {
            ...
            var path = this.skill.path ? this.skill.path : 'defaults/No_image_available.png';
...
var render = function() {
  ...
  var _h = _vm.$createElement
  var _c = _vm._self._c || _h
  return _c("div", { staticClass: "col-6 col-sm-5 col-md-4 col-lg-3" }, [
    _c(
      "div",
      {
        staticClass: "card card-skill text-white mb-3",
      ...
      [
        _c("span", { staticClass: "fa-icon" }, [
          _c("i", {
            staticClass: "fa",
            class: _vm.blur ? "fa-times-circle" : "fa-info-circle",
            attrs: { "aria-hidden": "true" }
          })
        ]),
        _vm._v(" "),
        _c(
          "div",
          {
            staticClass: "bg-dark card-blur card-skill",
            style: _vm.blur ? "opacity: 0.4" : ""
          },
          [
            _c("div", { staticClass: "card-header" }, [
              _c("span", { domProps: { textContent: _vm._s(_vm.skill.name) } }),
              _vm._v(" "),
              _vm.skill.level.value
                ? _c("span", { class: _vm.level })
                : _vm._e()
            ]),
            _vm._v(" "),
            _c("div", { staticClass: "card-body skill-img", style: _vm.image })
          ]
        ),
        _vm._v(" "),
        _c(
          "div",
          {
            ...
            staticClass: "card-description blur",
            class: _vm.blur ? "blur-active" : ""
          },
          [
            _c("div", { staticClass: "blur-content" }, [
              _vm.descriptions
                ? _c(
                    "div",
                    _vm._l(_vm.descriptions, function(description) {
                      return _c(
                        "span",
                        { staticClass: "badge badge-dark ml-1" },
                        [_vm._v(" " + _vm._s(description))]
                      )
                    })
                  )
                : _c("span", [_c("strong", [_vm._v("Pas de description")])])
            ]),
            _vm._v(" "),
            _c(
              "a",
              {
                staticClass: "btn btn-dark card-description-link",
                attrs: { target: "_blank", href: _vm.skill.url }
              },
              [_vm._v("Lien")]
            )
          ]
...
if (false) {
  module.hot.accept()
  if (module.hot.data) {
    require("vue-hot-reload-api")      .rerender("data-v-83d87bac", module.exports)
  }
}
...
Component.options.__file = "resources/assets/js/components/Hobby.vue"
...
if (false) {(function () {
  ...
  module.hot.accept()
  if (!module.hot.data) {
    hotAPI.createRecord("data-v-7c02cd2b", Component.options)
  } else {
    hotAPI.reload("data-v-7c02cd2b", Component.options)
  }
  module.hot.dispose(function (data) {
    disposed = true
  })
...
if(content.locals) module.exports = content.locals;
// add the styles to the DOM
var update = __webpack_require__(3)("1dc4f6b6", content, false, {});
// Hot Module Replacement
if(false) {
 // When the styles change, update the <style> tags
 if(!content.locals) {
   module.hot.accept("!!../../../../node_modules/css-loader/index.js!../../../../node_modules/vue-loader/lib/style-compiler/index.js?{\"vue\":true,\"id\":\"data-v-7c02cd2b\",\"scoped\":false,\"hasInlineConfig\":true}!../../../../node_modules/vue-loader/lib/selector.js?type=styles&index=0!./Hobby.vue", function() {
     var newContent = require("!!../../../../node_modules/css-loader/index.js!../../../../node_modules/vue-loader/lib/style-compiler/index.js?{\"vue\":true,\"id\":\"data-v-7c02cd2b\",\"scoped\":false,\"hasInlineConfig\":true}!../../../../node_modules/vue-loader/lib/selector.js?type=styles&index=0!./Hobby.vue");
     if(typeof newContent === 'string') newContent = [[module.id, newContent, '']];
     update(newContent);
   });
 }
...
/* harmony default export */ __webpack_exports__["default"] = ({
    ...
    props: { hobby: { type: Object } },
    data: function data() {
        return {
            blur: false,
            descriptions: this.hobby.description
        };
    },
    mounted: function mounted() {
        ...
        if (this.descriptions) {
            ...
            this.descriptions = this.hobby.description.split(',');
        }
    },
...
var render = function() {
  ...
  return _c(
    ...
    {
      staticClass:
        "card-hobbies-container col-5 col-sm-5 col-md-5 col-lg-3 offset-1",
      on: {
        click: function($event) {
          _vm.blur = !_vm.blur
        }
    ...
    [
      _c("div", { staticClass: "row text-white" }, [
        _c("span", { staticClass: "fa-icon", attrs: { id: "fa-icon" } }, [
          _c("i", {
            staticClass: "fa",
            class: _vm.blur ? "fa-times-circle" : "fa-info-circle",
            attrs: { "aria-hidden": "true" }
        ...
        _c(
          "div",
          {
            staticClass: "col-12 col-md-12 bg-dark card-blur card-hobby",
            style: _vm.blur ? "opacity:0.4" : ""
          },
          [
            _c(
              ...
              [
                _c("div", { staticClass: "col-12" }, [
                  _c("h4", [_vm._v(_vm._s(_vm.hobby.name))])
                ]),
                _vm._v(" "),
                _c(
                  "div",
                  { staticClass: "col-12 bg-dark text-white fa-icon-hobby" },
                  [
                    _c("i", {
                      staticClass: "fa fa-",
                      class: _vm.icon,
...
if (false) {
  module.hot.accept()
  if (module.hot.data) {
    require("vue-hot-reload-api")      .rerender("data-v-7c02cd2b", module.exports)
  }
}
...
if(content.locals) module.exports = content.locals;
// add the styles to the DOM
var update = __webpack_require__(3)("4a839a26", content, false, {});
// Hot Module Replacement
if(false) {
 // When the styles change, update the <style> tags
 if(!content.locals) {
...
/* harmony default export */ __webpack_exports__["default"] = ({
    ...
    computed: {
        showTimer: function showTimer() {
            ...
            return 'Vous devez attendre ' + this.remaining + 's pour r\xE9envoyer un message';
        }
    },
    created: function created() {
    ...
    methods: {
        init: function init() {
            this.errors = _extends({}, this.fields);
            this.form = _extends({}, this.fields);
        },
        reset: function reset() {
            this.sent = false;
            this.errors = _extends({}, this.fields);
        },
        lauchTimer: function lauchTimer() {
            var _this = this;
...
var render = function() {
  ...
  return _c("div", { staticClass: "row justify-content-center" }, [
    _c(
      ...
      [
        _c("flash", { attrs: { remaining: "remaining" } }),
        _vm._v(" "),
        _c("form", { attrs: { id: "form-contact" } }, [
          _c(
            "div",
              ...
              _c(
                ...
                _vm._l(_vm.errors.email, function(error) {
                  return _vm.errors.email
                    ? _c("span", { key: error, staticClass: "form-error" }, [
                        _vm._v(_vm._s(error))
                      ])
                    : _vm._e()
                })
          ...
          _c(
            ...
            [
              ...
              _c("input", {
                ...
                staticClass: "form-control lastname",
          ...
          _c(
            ...
            [
              ...
              _c("input", {
                ...
                staticClass: "form-control firstname",
          ...
          _c(
            ...
            [
              ...
              _c("textarea", {
                ...
                staticClass: "form-control form-message content",
          ...
          _c("div", { staticClass: "form-group" }, [
            _c("button", {
              ...
              domProps: {
                textContent: _vm._s(_vm.sent ? _vm.showTimer : "Envoyer")
              },
              on: { click: _vm.store }
            })
          ])
